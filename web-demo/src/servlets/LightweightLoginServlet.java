...
@WebServlet(name = "loginAttempt", urlPatterns = "/login")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (usernameFromSession == null) { //user is not logged in yet
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                 ...
                 */
                synchronized (this) {
                    if (bank.isUserExists(usernameFromParameter)) {
                        ...
                        bank.addUser(usernameFromParameter);
                        ...
                        response.getWriter().println("Login successful. Redirecting to customer main screen...");
                    }
                }
            }
        } else {
