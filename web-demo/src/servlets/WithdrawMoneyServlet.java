...
@WebServlet(name = "WithdrawMoneyServletFunc", urlPatterns = "/WithdrawMoneyServlet")
public class WithdrawMoneyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        bank.takeMoneyFromAccount(chargeDouble,bank.getCustomerIndex(bank.getCustomerByName(customerName)));
